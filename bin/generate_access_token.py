...
parser.add_argument("-a", "--app-name", help="your app's name", action="store", required=True)
parser.add_argument("-e", "--expiration", help="the token's expiration, defaults to 30days", default='30days', action="store")
parser.add_argument("-w", "--write-access", help="the token has write access", default=False,action="store_true")
